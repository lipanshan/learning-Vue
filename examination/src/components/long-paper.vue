    ...
    <div class="content">
      <div class="left-paper">
        <scroll class="list"
                ...
                ref="longPaperWrap">
          <div v-for="item in list" :key="item.id" class="list-item list-item-hook" :id="`item${item.id}`">
        ...
        <div class="submit-wrap">
          <div class="submit-btn" :class="{'disabled-cls': submitStatus.type}" @click="submitFn">我要交卷</div>
        </div>
      </div>
