    ...
    <div class="see-obtained">
        ...
        >
            ...
            <el-form-item label="证书类型" prop="certificate_id">
                <div class="el-input is-disabled el-input--suffix">
                    <div class="el-input__inner">{{form.certificate_name}}</div>
                </div>
            ...
            <el-form-item label="证书编号" prop="certificate_num">
                <div class="el-input is-disabled el-input--suffix">
                    <div class="el-input__inner">{{form.certificate_num}}</div>
                </div>
            </el-form-item>
            <el-form-item label="培训期数" prop="train_id">
                <div class="el-input is-disabled el-input--suffix">
                    <div class="el-input__inner">{{form.train_num}}</div>
                </div>
            </el-form-item>
...
import {getCertificateType, studentObtainedSeeInfo} from '@/api/student'

export default {
  name: "StudentSeeObtained",
  data() {
    return {
      title: '查看学员信息',
      backBtn: {
